...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://fleet-shield-preview-1.preview.emergentagent.com')
...
class TestRegistrationWithRole:
    ...
    def test_register_as_company_owner(self):
        ...
        payload = {
            ...
            "vehicle_count": 5,
            "role": "super_admin",
            "origin_url": "https://fleet-shield-preview-1.preview.emergentagent.com"
        }
